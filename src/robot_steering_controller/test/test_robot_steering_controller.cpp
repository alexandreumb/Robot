...
#include "test_robot_steering_controller.hpp"
...
class RobotSteeringControllerTest
: public RobotSteeringControllerFixture<TestableRobotSteeringController>
{
};

TEST_F(RobotSteeringControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
  ...
  ASSERT_EQ(controller_->robot_params_.wheelbase, wheelbase_);
  ASSERT_EQ(controller_->robot_params_.front_wheels_radius, front_wheels_radius_);
  ASSERT_EQ(controller_->robot_params_.rear_wheels_radius, rear_wheels_radius_);
  ASSERT_EQ(controller_->robot_params_.front_wheel_track, front_wheel_track_);
  ASSERT_EQ(controller_->robot_params_.rear_wheel_track, rear_wheel_track_);
}

TEST_F(RobotSteeringControllerTest, check_exported_interfaces)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, update_success)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, test_update_logic)
{
  SetUpController();
...
TEST_F(RobotSteeringControllerTest, test_update_logic_chained)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(RobotSteeringControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
