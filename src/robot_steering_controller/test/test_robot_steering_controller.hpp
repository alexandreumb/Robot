...
#ifndef TEST_ROBOT_STEERING_CONTROLLER_HPP_
#define TEST_ROBOT_STEERING_CONTROLLER_HPP_
...
using robot_steering_controller::STATE_STEER_LEFT_WHEEL;
using robot_steering_controller::STATE_STEER_RIGHT_WHEEL;
using robot_steering_controller::STATE_TRACTION_LEFT_WHEEL;
using robot_steering_controller::STATE_TRACTION_RIGHT_WHEEL;

// name constants for command interfaces
using robot_steering_controller::CMD_STEER_LEFT_WHEEL;
using robot_steering_controller::CMD_STEER_RIGHT_WHEEL;
using robot_steering_controller::CMD_TRACTION_LEFT_WHEEL;
using robot_steering_controller::CMD_TRACTION_RIGHT_WHEEL;
...
class TestableRobotSteeringController
: public robot_steering_controller::RobotSteeringController
{
  FRIEND_TEST(RobotSteeringControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(RobotSteeringControllerTest, check_exported_interfaces);
  FRIEND_TEST(RobotSteeringControllerTest, activate_success);
  FRIEND_TEST(RobotSteeringControllerTest, update_success);
  FRIEND_TEST(RobotSteeringControllerTest, deactivate_success);
  FRIEND_TEST(RobotSteeringControllerTest, reactivate_success);
  FRIEND_TEST(RobotSteeringControllerTest, test_update_logic);
  FRIEND_TEST(RobotSteeringControllerTest, test_update_logic_chained);
  FRIEND_TEST(RobotSteeringControllerTest, publish_status_success);
  FRIEND_TEST(RobotSteeringControllerTest, receive_message_and_publish_updated_status);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    return robot_steering_controller::RobotSteeringController::on_configure(previous_state);
  }
    ...
    const rclcpp_lifecycle::State & previous_state) override
  {
    ...
    return robot_steering_controller::RobotSteeringController::on_activate(previous_state);
  }
...
class RobotSteeringControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_robot_steering_controller/reference", rclcpp::SystemDefaultsQoS());
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_robot_steering_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_robot_steering_controller/controller_state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableRobotSteeringController> controller_;
  rclcpp::Node::SharedPtr command_publisher_node_;
  rclcpp::Publisher<ControllerReferenceMsg>::SharedPtr command_publisher_;
};

#endif  // TEST_ROBOT_STEERING_CONTROLLER_HPP_
