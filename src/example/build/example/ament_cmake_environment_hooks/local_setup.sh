...
: ${AMENT_CURRENT_PREFIX:="/home/alexandre/iceoryx_demo_ws/src/example/install/example"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example/environment/pythonpath.sh"
