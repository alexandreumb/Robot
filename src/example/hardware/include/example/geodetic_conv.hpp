// LAtitude and Longitude should be given in RAD!
...
class GeodeticConverter
{
 public:
  ...
  {
    // Save NED origin
    initial_latitude_ = latitude;//deg2Rad(latitude);
    initial_longitude_ = longitude;//deg2Rad(longitude);
                     ...
                     double* y, double* z)
  {
    ...
    double lat_rad = latitude;//deg2Rad(latitude);
    double lon_rad = longitude;//deg2Rad(longitude);
                     ...
                     double* longitude, double* altitude)
  {
    ...
    *latitude = atan((z + kSecondEccentricitySquared * Z_0) / r);//rad2Deg(atan((z + kSecondEccentricitySquared * Z_0) / r));
    *longitude = atan2(y, x);//rad2Deg(atan2(y, x));
  }
