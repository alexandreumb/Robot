...
#include "four_wheels_steering_controller/four_wheels_steering_controller.hpp"
...
{
FourWheelsSteeringController::FourWheelsSteeringController()
()
: controller_interface::ChainableControllerInterface()
{
}

controller_interface::CallbackReturn FourWheelsSteeringController::on_init()
{
  try
  {
...
controller_interface::CallbackReturn FourWheelsSteeringController::set_interface_numbers(
...
controller_interface::CallbackReturn FourWheelsSteeringController::on_configure(
...
void FourWheelsSteeringController::reference_callback(
  const std::shared_ptr<ControllerTwistReferenceMsg> msg)
{
...
void FourWheelsSteeringController::reference_callback_unstamped(
...
FourWheelsSteeringController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
FourWheelsSteeringController::state_interface_configuration() const
{
...
FourWheelsSteeringController::on_export_reference_interfaces()
{
...
bool FourWheelsSteeringController::on_set_chained_mode(bool /*chained_mode*/) { return true; }

controller_interface::CallbackReturn FourWheelsSteeringController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn FourWheelsSteeringController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type FourWheelsSteeringController::update_reference_from_subscribers()
{
...
controller_interface::return_type FourWheelsSteeringController::update_and_write_commands(
